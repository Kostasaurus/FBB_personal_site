...
print(f"Helix: {helix}, Transmembrane: {transmembrane}, All: {proteins_count}")`}
			...
			<section className="mb-5 text-center">
				...
				<div className="text-left space-y-2">
					...
					<p>Значения довольно близки и можно предположить, что это свидетельствует о том, что они отражают реальное количество ферментов (хотя по моему мнению их как-то мало)</p>
				</div>
			</section>
